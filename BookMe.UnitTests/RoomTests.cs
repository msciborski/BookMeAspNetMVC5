...
namespace BookMe.UnitTests {
    ...
    public class RoomTests{
        ...
        public void CanReturn6LatestRooms(){
            ...
            var data = new Room[]{
                new Room(){RoomID = 1, Name = "R1", AddDate = DateTime.Parse("21.08.2017"), Hotel = hotel, Photos = photos},
                new Room(){RoomID = 2, Name = "R2", AddDate = DateTime.Parse("22.08.2017"), Hotel = hotel, Photos = photos},
                new Room(){RoomID = 3, Name = "R3", AddDate = DateTime.Parse("23.08.2017"), Hotel = hotel, Photos = photos},
                new Room(){RoomID = 4, Name = "R4", AddDate = DateTime.Parse("24.08.2017"), Hotel = hotel, Photos = photos},
                new Room(){RoomID = 5, Name = "R5", AddDate = DateTime.Parse("25.08.2017"), Hotel = hotel, Photos = photos},
                new Room(){RoomID = 6, Name = "R6", AddDate = DateTime.Parse("26.08.2017"), Hotel = hotel, Photos = photos},
                new Room(){RoomID = 7, Name = "R4", AddDate = DateTime.Parse("27.08.2017"), Hotel = hotel, Photos = photos},
            };
            ...
            mockRoomSet.Setup(m => m.Include("Photos")).Returns(mockRoomSet.Object);
